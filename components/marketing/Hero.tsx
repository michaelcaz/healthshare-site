        ...
        <div className="relative container mx-auto px-4 py-16 flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            ...
            <p className="text-xl leading-relaxed text-gray-warm/80 mb-10 max-w-xl">
              Tired of being gouged by Big Insurance? Join 2M+ Americans saving 30-50% on healthcare while keeping their trusted doctors. Find the best plan for your family's needs, at the lowest price, in under 2 minutes.
            </p>
            <motion.form 
            ...
            >
              <input
                ...
                className="flex-1 px-6 bg-transparent outline-none text-lg text-gray-600 placeholder-gray-400"
                maxLength={5}
                pattern="[0-9]*"
              />
              <motion.button
                type="submit"
                className="px-8 py-2 bg-[#FF4500] hover:bg-[#E03E00] text-white font-semibold rounded-full transition-all duration-200"
