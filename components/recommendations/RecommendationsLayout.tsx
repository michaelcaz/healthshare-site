...
import { CompareSnackbar } from '@/components/ui/CompareSnackbar'
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="py-16">
            ...
            <div className="text-center mb-16">
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-6 text-center break-words" style={{ hyphens: 'none' }}>
                Your Personalized{' '}
