  ...
  headers: async () => [
    {
      ...
      headers: [
        ...
        },
        {
          ...
          value: "default-src 'self'; script-src 'self' 'unsafe-inline' https://va.vercel-scripts.com; style-src 'self' 'unsafe-inline'; img-src 'self' data: https://cdn.sanity.io https://lrwewkxwfgmzkvhozdin.supabase.co; font-src 'self'; connect-src 'self' https://vitals.vercel-insights.com https://*.sentry.io https://*.supabase.co https://cdn.sanity.io; manifest-src 'self'; base-uri 'self'; form-action 'self';"
        }
      ],
    },
    {
