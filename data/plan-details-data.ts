...
export const planDetailsData: Record<string, PlanDetailsData> = {
  ...
  'zion-healthshare-essential-membership': {
    ...
    coverageDetails: {
      ...
      pregnancy: "You must be a member for 6 months before conceiving, for your pregnancy related needs to be eligible for sharing. Services available for sharing include pre-natal, delivery (including birthing centers and home-births), post-natal, and miscarriage.",
      preExistingConditions: "Starting on the day you sign up, there is a one-year waiting period before pre-membership medical conditions are eligible for sharing. After the waiting period, the amount eligible for sharing increases with each membership year. In Year One, no sharing is available. In Year Two, up to $25,000 is eligible for sharing per request. In Year Three, that amount increases to $50,000. By Year Four (and beyond), the maximum eligible for sharing per request rises to $125,000."
    },
    medicalServices: {
      emergencyCare: "**ER visits are generally eligible for sharing**, whether or not they are in conjunction with an eligible medical need. The first ER visit for a medical condition is treated as a normal sharing request. Each additional visit related to the same condition requires the member to take on a personal responsibility of $500 in addition to the member's IUA.",
      surgeryAndTreatment: "**Covered for eligible medical needs**. For any non-emergency surgery, you can get prior authorization to ensure that your surgery will be fully shared.",
  ...
  'crowdhealth-membership': {
    ...
    coverageDetails: {
      ...
      preExistingConditions: "Starting on the day you sign up, there is a two-year waiting period before pre-membership medical conditions are eligible for sharing. After the waiting period, the amount eligible for sharing is limited each year:<br/><br/><strong>Year One:</strong> $0 (waiting period)<br/><strong>Year Two:</strong> $0 (waiting period)<br/><strong>Year Three:</strong> $25,000 maximum per sharing request<br/><strong>Year Four (and beyond):</strong> $25,000 maximum per sharing request"
    },
    medicalServices: {
  ...
  'sedera-access+': {
    ...
    coverageDetails: {
      ...
      preExistingConditions: "Starting on the day you sign up, there is a one-year waiting period before pre-membership medical conditions are eligible for sharing. After the waiting period, the amount eligible for sharing increases with each membership year:<br/><br/><strong>Year One:</strong> $0 (waiting period)<br/><strong>Year Two:</strong> $15,000 maximum per sharing request<br/><strong>Year Three:</strong> $30,000 maximum per sharing request<br/><strong>Year Four (and beyond):</strong> Fully shareable<br/><br/>This means that after 36 months of continuous membership, pre-existing conditions are no longer subject to sharing limits and are fully shareable."
    },
    medicalServices: {
  ...
  'sedera-access+-+dpc/vpc': {
    ...
    coverageDetails: {
      ...
      pregnancy: "You must be a member for 3 months before conceiving, for your pregnancy related needs to be eligible for sharing. Services available for sharing include pre-natal, delivery (including birthing centers and home-births), post-natal, and miscarriage. Regardless of your chosen IUA, there is a $5,000 IUA applied to normal vaginal deliveries and emergency C-Section deliveries. There is a $7,500 IUA applied to elective/planned C-Section deliveries.",
      preExistingConditions: "Starting from the membership start date, there is a one-year waiting period before pre-membership medical conditions are eligible for sharing. After the waiting period, the amount eligible for sharing increases with each membership year:<br/><br/><strong>Year One:</strong> $0 (waiting period)<br/><strong>Year Two:</strong> $15,000 maximum per sharing request<br/><strong>Year Three:</strong> $30,000 maximum per sharing request<br/><strong>Year Four:</strong> Fully Shareable"
    },
    medicalServices: {
      emergencyCare: "**ER visits, including medically necessary ambulance rides are generally eligible for sharing**. Air ambulance rides are eligible for sharing for up to $25,000.",
      surgeryAndTreatment: "**Surgical procedures are generally shareable once the member's Initial Unshareable Amount (IUA) is met and the procedure qualifies as a shareable need. There is no general waiting period for surgeries unless related to a pre-existing condition, in which case standard sharing limitations apply.<br/><br/>For non-emergency treatments, Sedera may require participation in their Expert Second Opinion (ESO) program prior to sharing. Advance notice is strongly encouraged, and any requests for upfront sharing on procedures over $3,000 must be submitted at least 14 days in advance. ",
